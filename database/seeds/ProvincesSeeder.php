...
class ProvincesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('provinces_translations')->truncate();


        DB::insert("INSERT INTO `provinces_translations` (`id`, `name`, `country_id`) VALUES
            (1918, '愛知県', 109),
            (1919, '秋田県', 109),
            (1920, '青森県', 109),
            (1921, '千葉県', 109),
        ...
        DB::insert("INSERT INTO `provinces` (`id`, `name`, `country_id`) VALUES
            ...
            (3977, 'Wisconsin', 231),
            (3978, 'Wyoming', 231),
            (3979, 'United provinces Minor Outlying I', 232),
            (3980, 'Artigas', 233),
            (3981, 'Canelones', 233),
